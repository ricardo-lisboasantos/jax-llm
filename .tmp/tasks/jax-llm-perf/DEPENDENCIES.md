...
**Version:** 1.0  
**Date:** 2025-09-21  
**Purpose:** Architect-to-Engineer handoff; shows exact blocking dependencies and parallel opportunities
...
**Sequencing Rule:** Start all 3 Monday 9am. No ordering. Parallel OK = 1d wall-clock.
...
**Parallelization:** 5 concurrent developers (Forge×3, Medic×1, Guardian prep M-06)  
**Wall-clock:** Week 2 Mon start → Week 3 Wed M-06 passes (can do earlier if M-03+M-04 finish Fri of Week 2)
...
2. **L-02 is GATEKEEPER for L-05**
   ...
   - Can prototype speculative logic in parallel, but not integrate until L-02 stable
...
- **Mitigation:** Start L-02 design early; have fallback (single-GPU optimizations sufficient?)

### If L-02 overruns (multi-GPU complexity)
- **Action:** Parallelize L-02 design+implementation; call out bottleneck early (Week 4 Mon)
...
- **Mitigation:** Aggressive unit testing in M-06 + integration testing in L tasks
